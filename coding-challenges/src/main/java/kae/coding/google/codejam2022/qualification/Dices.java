package kae.coding.google.codejam2022.qualification;
 ...
 *
 * <p>Dice from sample case 1
 *
 * <p>In this problem, we start with a collection of N dice. The i-th die is a dSi, that is, it has
 * Si sides showing integers 1 through Si. A straight of length ℓ starting at x is the list of
