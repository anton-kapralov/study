 ...
 * <p>
 * Cutting the deck once consists of taking a stack of between 11 and N - 1N−1 cards from the top and moving it to
 * the bottom in the same order. For example, for the deck [5,1,2,4,3] ordered from top to bottom,
 * cutting 22 cards from the top would yield [2,4,3,5,1].
 * <p>
 * Initially, the ith card from the top is Ai. Is it possible to cut the deck exactly K times to reorder the deck such
 * that the ith card from the top is Bi for all i?
 */
